...
//
const APP_NAME: string = "ElettoOS";   // 'cause Bob and I were at a loss for a better name.
...
var _DefaultFontFamily: string = "Roboto";        // Ignored, I think. The was just a place-holder in 2008, but the HTML canvas may have use for it.
